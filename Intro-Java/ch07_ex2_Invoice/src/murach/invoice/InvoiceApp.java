...
10.18.2016
Chapter 7-2 
Remove a rounding statement, use the methods of the BigDecimal class. Project contains the InvoiceApp class only. 
*/ 
...
public class InvoiceApp {
	...
	public static void main(String[] args) {
        ...
        while (!choice.equalsIgnoreCase("n")) 
        {
            ...
            BigDecimal subtotal = new BigDecimal(keyboard.nextLine())
