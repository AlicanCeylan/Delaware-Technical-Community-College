...
11.15.2016
Chapter 10-2 
Create a two-dimensional rectangular array. Convert values to string and store in the array. Display array contents. Project contains the Main, Console, and Financial classes. 
*/ 
...
public class Main {
    ...
    public static void main(String[] args) 
    {
        ...
        //string array with 5 rows and 4 columns
	    ...
	    // get the currency and percent formatters
            ...
            // format the values and put them in the array
	...
	//EOP message
	Console.displayLine("End of Program.");
    }
}